...
file_path = r'D:\Guvi\Capstone\GUVI-CAPSTONE-PROJECTS\BizCardX-Extracting_Business_Card_Data_with_OCR-main\icon.png'
icon = Image.open(file_path)
st.set_page_config(page_title= "BizCardX",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Santhosh Kumar*!"""})
...
if selected == "Home":
    ...
    with col1:
        ...
        st.markdown("## :green[**Objective :**] This application allows you to upload a business card image and extracting its information. The extracted information would be displayed in a clean and organized manner, and users would be able to easily add it to the database with the click of a button and if they wish to change any of the data they can do so by using the modify option.")
